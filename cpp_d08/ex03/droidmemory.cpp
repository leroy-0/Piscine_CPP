...
bool				DroidMemory::operator==(const DroidMemory & b) const
{
	if (this->getExp() == b.getExp() && this->getFingerPrint() == b.getFingerPrint())
		return (true);
	return (false);
}
...
{
	if (a.getExp() > b.getExp() && a.getFingerPrint() > b.getFingerPrint())
		return (true);
	return (false);
}
...
{
	if (a.getExp() > b && a.getFingerPrint() > b)
		return (true);
	return (false);
}
